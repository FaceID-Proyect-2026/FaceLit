...
export default function AdminLayout() {
  ...
  // regreso al menú principal: ni la flecha propia de la pantalla (se
  // eliminó en app/admin/facial/index.tsx) ni el menú lateral/dashboard
  // de este layout compartido. Se detecta la ruta para ocultar el botón
  // que abre el Sidebar únicamente mientras el admin está dentro de este
  // módulo, sin afectar el resto de pantallas admin.
  const isFacialLockedScreen = pathname.startsWith('/admin/facial');
  ...
  return (
    <SafeAreaView style={[sal.safe, { backgroundColor: bg }]} edges={['top']}>
      ...
      {/* Sidebar overlay — nunca se renderiza dentro del módulo de
          Reconocimiento Facial, aunque sidebarOpen hubiera quedado true
          de una pantalla anterior */}
      {!isFacialLockedScreen && (
