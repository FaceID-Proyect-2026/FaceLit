...
// RF-6.4: el admin/coordinador/instructor consulta asistencias de una
// ficha puntual, elegida a través de su programa de formación.
// "Anomalías" (invalidEnv) queda fuera del alcance de este panel — solo
// puntual/retraso/inasistencia. Pantalla compartida entre admin e
// instructor (ver app/instructor/attendance/index.tsx).
      ...
      renderItem={({ item }) => {
        ...
        return (
          <TouchableOpacity accessibilityRole="button" accessibilityLabel={`${t('attendance.detail')}: ${item.userName}`}
            onPress={() => router.push(`${basePath}/attendance/${item.id}`)}
