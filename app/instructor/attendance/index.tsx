  ...
  return (
    <View style={[s.root, { backgroundColor: bg }]}>
      ...
      <View style={[s.tabBar, { backgroundColor: cardBg, borderColor: border }]}>
        {[
          { key: 'byFicha' as const, label: t('attendance.rf6.tabByFicha'), icon: 'people-outline' as const },
          { key: 'byUser' as const, label: t('attendance.rf6.tabByUser'), icon: 'person-outline' as const },
        ].map(tab => {
