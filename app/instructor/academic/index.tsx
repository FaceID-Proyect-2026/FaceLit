      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={[s.cardSub, { color: muted }]}>{t('instructorAcademic.created')}: {formatDateTime(item.createdAt)}</Text>
            <Text style={[s.cardSub, { color: muted }]}>{t('instructorAcademic.lastEdited')}: {formatDateTime(item.updatedAt)}</Text>
