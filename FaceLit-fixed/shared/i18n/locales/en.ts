const en = {
  ...
  environments: {
    ...
    fields: { code: 'Name', name: 'Environment Name', namePlaceholder: 'E.g.: 209, 209-1, Laboratory A', nameInvalid: 'Invalid format. E.g.: 209, 209-1, Laboratory A', type: 'Type', capacity: 'Capacity', status: 'Status', location: 'Location' },
