...
// ─────────────────────────────────────────────
  ...
  environments: {
    ...
    fields: { code: 'Name', name: 'Environment Name', type: 'Type', capacity: 'Capacity', status: 'Status', location: 'Location' },
    ...
    detail: { title: 'Environment Detail', info: 'General Information', assignedFichas: 'Assigned Fichas', noFichas: 'No fichas assigned', removeFicha: 'Remove ficha', removeFichaConfirm: 'Remove this ficha from the environment? The ficha will not be deleted from the system.', removeFichaSuccess: 'Ficha unassigned successfully' },
  },
  academic: {
