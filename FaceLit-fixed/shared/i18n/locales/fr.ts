const fr = {
  ...
  environments: {
    title: 'Gestion des Environnements', subtitle: 'Gérer les environnements', register: 'Enregistrer', edit: 'Modifier', delete: 'Supprimer', search: 'Rechercher un environnement', emptyState: 'Aucun environnement', confirmDelete: 'Cela marquera l\'environnement comme Inactif. Continuer ?', noDeleteActive: 'Impossible: fichas actives',
    fields: { code: 'Nom', name: 'Nom de l\'Environnement', type: 'Type', capacity: 'Capacité', status: 'Statut', location: 'Emplacement' },
    ...
    assign: { title: 'Assigner Ficha', selectFicha: 'Sélectionner Ficha', selectEnv: 'Sélectionner Environnement', assignBtn: 'Assigner', successMsg: 'Ficha assignée', noFichas: 'Aucune ficha', noEnvs: 'Aucun environnement', capacityWarning: 'Capacité dépassée', removeFicha: 'Retirer la ficha', removeFichaConfirm: 'Retirer cette ficha de l\'environnement ? La ficha ne sera pas supprimée du système.', removeFichaSuccess: 'Ficha désassignée avec succès' },
    detail: { title: 'Détail', info: 'Info Générale', assignedFichas: 'Fichas Assignées', noFichas: 'Aucune ficha', removeFicha: 'Retirer la ficha', removeFichaConfirm: 'Retirer cette ficha de l\'environnement ? La ficha ne sera pas supprimée du système.', removeFichaSuccess: 'Ficha désassignée avec succès' },
  },
  academic: {
