const fr = {
  ...
  environments: {
    ...
    fields: { code: 'Nom', name: 'Nom de l\'Environnement', namePlaceholder: 'Ex. : 209, 209-1, Laboratoire A', nameInvalid: 'Format invalide. Ex. : 209, 209-1, Laboratoire A', type: 'Type', capacity: 'Capacité', status: 'Statut', location: 'Emplacement', quantity: 'Quantité' },
