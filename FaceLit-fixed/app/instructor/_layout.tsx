...
export default function InstructorLayout() {
  ...
  if (!canRenderContent) {
    return (
      <SafeAreaView style={[il.safe, { backgroundColor: isDark ? Colors.dark.background : Colors.light.background }]}>
        <View style={il.loadingContainer}><ActivityIndicator size="large" color={theme.primary} /></View>
      </SafeAreaView>
    );
  }
