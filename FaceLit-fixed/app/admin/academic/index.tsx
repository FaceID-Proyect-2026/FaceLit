...
const aps = StyleSheet.create({
  ...
  tabRow: { flexDirection: 'row', gap: 8, marginHorizontal: 16, marginTop: 4, marginBottom: 8 },
  tabChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 10, borderWidth: 1.2 },
  tabChipText: { fontSize: FontSize.sm, fontWeight: FontWeight.bold },
